            ...
            <div className="md::flex-row flex w-full flex-col gap-2 whitespace-nowrap sm:mx-auto md:mx-0 md:block md:gap-0 md:gap-y-1">
              {features.map((feature) => (
                <div key={feature.title}>
                  <button
                    className={cn(
                      "group relative rounded-2xl text-center md:rounded-l-xl md:rounded-r-none md:p-6 md:text-start md:hover:bg-gradient-to-br md:hover:from-blue-600/20 md:hover:to-purple-600/20",
                      activeFeature === feature
                        ? "md:bg-gradient-to-br md:from-blue-600/10 md:to-purple-600/10"
