  ...
  return (
    <div className="my-32 flex w-full flex-col items-center gap-12 text-center">
      <div className="grid grid-cols-1 gap-8">
        <Balancer>
          <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text font-urbanist text-4xl font-extrabold tracking-tight text-transparent sm:text-5xl md:text-6xl lg:text-7xl">
            Upcoming Feature
          </span>
        </Balancer>
