          ...
          <div className="flex flex-col space-y-6">
            ...
            <LinkWrapper locale={lang} href={"/dashboard"}>
              <div className="flex gap-1 items-center justify-self-start text-xs">
                <div className={"italic underline font-bold"}>Do you want to go back</div>
        ...
        <div className="flex-1 overflow-auto p-6 md:p-8 lg:p-10">
          <div className="mx-auto max-w-md space-y-6">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">Review your order and complete the purchase.</p>
            </div>
            <Accordion type="single" defaultValue={!billingInfo ? "billing-info" : "credit-card"} collapsible
              ...
              <AccordionItem value="credit-card">
                ...
                <AccordionContent>
                  <CreditCard productId={productId} price={product?.id} userId={user?.id}/>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
