...
import { useCurrentRoute, useParams } from "next-navigation";
...
const Hero = ({ dict }: any) => {
	...
	return (
		<>
			<section
				id='home'
				className='relative overflow-hidden bg-blue pt-[120px] md:pt-[130px] lg:pt-[160px]'
			>
						...
						<div className='w-full px-4'>
							...
							>
								...
								<p className='mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]'>
									Next.js SaaS Boilerplate and Starter Kit designed and built for SaaS startups. It
									comes with all necessary integrations, pages, and components you need to launch a
									feature-rich SaaS websites.
								</p>
